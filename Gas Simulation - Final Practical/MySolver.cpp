...
{
	//ApplyForce(vector3(0.0f, -0.035f, 0.0f));	//default gravity
	ApplyForce(vector3(0.0f, -0.0015f, 0.0f));	//trying to almost nullify gravity
	...
	m_v3Acceleration = ZERO_V3;	// COMMENT THIS OUT TO HAVE CONTINUOUS BOUNCING/MOVEMENT
}
